...
Here there are two questions: i) do we refer to redeemers:
...
and simmilarly as above, ii) do we keep redeemers:
a) alongside withdrawals, minting policies and inputs accordingly
b) in seperate containers
c) in one common container
