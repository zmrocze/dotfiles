...
Of course we can use any indexes in such a map and still lookup RedeemerPtr's indirectly by first linking to *something* that is stored alongside the input/withdrawal and then searching for something in the map.
