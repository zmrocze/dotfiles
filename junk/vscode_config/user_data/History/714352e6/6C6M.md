...
Of course such a map could still be indexed by *something* and RedeemerPtr would link to redeemer indirectly but first linking to *something* that is stored alongside the input/withdrawal and then searching for something in the map.
