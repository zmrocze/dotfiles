...
data TxConstr'List a b where 
    Cons :: TxConstr' b c -> TxConstr' a b -> TxConstr'List a c

-- toConstrList :: [TxConstrEx] -> TxConstr'List a b
-- toConstrList [TxConstrEx a , TxConstrEx b] = Cons a b
...
tx2tx' (MustPayToOtherScript vlhash mstake dt val) = MustPayToOtherScript' vlhash mstake dt val
