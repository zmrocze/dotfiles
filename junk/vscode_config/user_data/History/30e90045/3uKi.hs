...
buildTx (MustHashDatum' datumhash datum) fail a sl = a $ sl {slOtherData = Map.insert datumhash datum (slOtherData sl) }
buildTx (MustValidateIn' timerange) fail a sl = a sl -- what to do here?
