...
data TxConstr'List a b where 
    Cons :: TxConstr' b c -> TxConstr'List a b -> TxConstr'List a c

toConstrList :: [TxConstrEx] -> TxConstr'List a b
toConstrList [TxConstrEx (MustHashDatum' dh d) , TxConstrEx (MustValidateIn' time)] = Cons (MustHashDatum' dh d) (MustValidateIn' time)
