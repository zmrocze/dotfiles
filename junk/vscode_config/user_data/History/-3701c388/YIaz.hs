...
--
-- @since 0.2
shouldSucceed :: (Show e, Show a, Show w) => Predicate w e k a
shouldSucceed =
  Predicate
...
prettyExecutionResult :: (Show e, Show w, Show a, Show k) => ExecutionResult w e a -> Doc ann
...
--
-- @since 0.2
shouldFail :: (Show e, Show a, Show w) => Predicate w e k a
