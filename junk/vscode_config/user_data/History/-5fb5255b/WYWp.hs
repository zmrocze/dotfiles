...
import Plutus.ChainIndex.Config (ChainIndexConfig (cicNetworkId), cicDbPath, cicSocketPath)
...
launchChainIndex = do
  ...
  CM.setMinSeverity config Severity.Debug
  ...
  print $ cicPort chainIndexConfig  
