...
invalidScript = property $ do
    ...
    invalidTxn <- forAll $ Gen.genValidTransactionSpending [TxInputWitnessed (snd outToSpend) (ConsumeScriptAddress _ failValidator unitRedeemer unitDatum)] totalVal
