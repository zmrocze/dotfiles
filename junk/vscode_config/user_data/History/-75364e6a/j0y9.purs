...
import Ctl.Internal.Plutip.Server (checkPlutipServer, startPlutipCluster, startPlutipServer, stopChildProcessWithPort, stopPlutipCluster)
...
main = launchAff_ do
  Utils.interpretWithConfig
    ...
    $ group "Plutip" do
        replicateM_ 10 testStartPlutipCluster
