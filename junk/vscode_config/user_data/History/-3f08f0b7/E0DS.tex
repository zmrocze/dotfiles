...
\begin{bzFrame}
	...
	\bzOn{
		\bzResolution{}{Two clauses: $c_1=\{A_1\} \cup R_1$ and $c_2=\{\lnot A_2\} \cup R_1$.
		Resolvent would be $R_1\theta \cup R_2\theta$.}
	}
	\bzOn{
		\bzFactoring{}{A clause: $c_1=\{A_1, A_2\} \cup R$.
		Factor would be $R_1\theta \cup R_2\theta$.}
	}
	\bzOn{
		\bzItem{Literały muszą być maksymalne}
	}
\end{bzFrame}
% =============================================================================
