...
\begin{bzFrame}
	...
	\bzOn{
		...
		Czynnikiem byłaby $\{A_1\theta\}\cup R\theta$.}
	}
	\bzOn{
...
\begin{bzFrame}
	...
	\bzOn{
		\bzItem{Działa dla wszystkich formuł $\GF$}
	}
...
\begin{bzFrame}
	...
	\bzOn{
		...
		\node[bzG] at (1, -8) {\includegraphics[width=18cm]{scr_impl_1.png}};
	}
...
\begin{bzFrame}
	...
	\bzOn{
		...
		\node[bzG] at (1, -8) {\includegraphics[width=14cm]{scr_impl_2.png}};
	}
