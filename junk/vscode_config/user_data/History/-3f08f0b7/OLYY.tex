...
\begin{bzFrame}
	...
	\bzOn{
        \bzBox{
			Initial formula: (∀ (1, 2) S(1, 2) → P(1) ∧ ¬P(2)) ∧ (∃ (1, 2, 3) R(1, 2, 3) ∧ S(1, 2) ∧ S(2, 3))

NNFed: (∀ (1, 2) S(1, 2) → P(1) ∧ ¬P(2)) ∧ (∃ (1, 2, 3) R(1, 2, 3) ∧ S(1, 2) ∧ S(2, 3))

Structed: {∀ () a() → (∀ (1, 2) S(1, 2) → P(1) ∧ ¬P(2)), a() ∧ (∃ (1, 2, 3) R(1, 2, 3) ∧ S(1, 2) ∧ S(2, 3))}

Skolemized: {∀ () a() → (∀ (1, 2) S(1, 2) → P(1) ∧ ¬P(2)), a() ∧ R(a(), b(), c()) ∧ S(a(), b()) ∧ S(b(), c())}

Clausified: {¬a() v ¬S(1, 2) v P(1); ¬a() v ¬S(1, 2) v ¬P(2); a(); R(a(), b(), c()); S(a(), b()); S(b(), c())}

Final clause set: {; R(a(), b(), c()); ¬a() v ¬S(1, 2) v P(1); ¬P(b()); ¬a() v P(a()); P(b()); S(a(), b()); a(); ¬a() v ¬S(1, 2) v ¬P(2); ¬a() v ¬P(b()); ¬a(); P(a()); ¬P(c()); S(b(), c()); ¬a() v ¬P(c()); ¬a() v P(b())}
