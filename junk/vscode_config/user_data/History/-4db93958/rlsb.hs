...
import Plutus.V1.Ledger.Api (Datum (Datum), DatumHash, MintingPolicy, MintingPolicyHash (MintingPolicyHash), Redeemer, Validator,
                             ValidatorHash)
...
addOwnInput ScriptInputConstraint{icRedeemer, icTxOutRef} = do
    ...
    case Typed.tyTxInTxIn txIn of
        ...
        Tx.TxIn outRef (Just (ConsumeScriptAddress validator rs dt)) -> do
