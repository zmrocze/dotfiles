...
-- Used in wallet initialization specifies requested wallet, used in lookups specifies expected returned wallet type.  
...
data TestWallet t k = TestWallet
  ...
  , twExpected :: Maybe (ValueOrdering, Value)
    -- k is type of wallet name to be used in lookups, t implies type of wallet to be created
  , twTag :: WalletTag t k
  }
