...
import Ledger (Redeemer, Credential, DCert, txRedeemers, StakingCredential)
...
export params utx =
    ...
    in ExportTx
        ...
        <*> either (const $ Right []) (pure . mkRedeemers) unBalancedTxTx
...
-- TODO: Here there's hidden error of script DCert missing its redeemer. Don't know if bad.
