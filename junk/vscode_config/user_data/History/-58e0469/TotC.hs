...
scriptPurposeToExportRedeemer (Ledger.Rewarding (Plutus.StakingHash cred))   rd = RewardingRedeemer {redeemerStakingCredential = cred, redeemer=rd}
scriptPurposeToExportRedeemer (Ledger.Rewarding ) = _
