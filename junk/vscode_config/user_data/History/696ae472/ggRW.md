...
#### Description
The protocol mantains a single INDY utxo at the vesting script address, given that a distributor is different from the vesting script. The validator has to spend that and only that INDY input.
#### 
No vulnerability.
