...
#### Description
The protocol mantains a single INDY utxo at the vesting script address, given distributor address differe. The validator has to spend that and only that INDY input.
#### 
No vulnerability.
