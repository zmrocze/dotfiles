          ...
          pre-commit-check = let 
            ...
            in pre-commit-hooks.lib.${system}.run {
              ...
              hooks = {
                ...
                statix.enable = excludeSpago;
                deadnix.enable = excludeSpago;
                ...
                haskellFormat = {
                  enable = true; 
                  name = "haskell format";
                  entry = onchain-plutarch.apps.${system}.formatting;
                  #  pass_filenames = false;
                };
                haskellLint = {
                  enable = true; 
                  name = "haskell linter";
                  entry = onchain-plutarch.apps.${system}.linting;
                  #  pass_filenames = false;
                };
              };
            };
