...
import Plutus.ApiCommon (Language (PlutusV1, PlutusV2))
...
scriptTxIn :: Language -> TxOutRef -> Validator -> Redeemer -> Datum -> TxIn
...
data TxInputType =
      TxConsumeScriptAddress !Language !Redeemer !ValidatorHash !DatumHash -- ^ A transaction input that consumes a script address with the given validator, redeemer, and datum.
...
addScriptTxInput :: TxOutRef -> Language -> Validator -> Redeemer -> Datum -> Tx -> Tx
