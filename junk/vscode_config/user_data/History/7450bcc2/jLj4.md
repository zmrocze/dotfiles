...
### Redefines `Tx` type
 ...
 - script and datum witnesses get put into maps and refered to by hashes ([related comment](https://github.com/input-output-hk/plutus-apps/issues/471#issuecomment-1133941543) and  )
