...
--
--    - BudgetCounting, for displaying transaction execution budgets
--    - ShowTrace, for displaying contract execution trace
--    - TracingButOnlyContext, like ShowTrace but filter what to show
--
...
import Test.Plutip.Options (TraceOption (BudgetCounting, ShowTrace, TracingButOnlyContext))
...
--
-- > assertExecutionWith [ShowTrace, BudgetCounting]
--
