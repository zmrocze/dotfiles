...
only validator redeemers are taken, not minting. Also the field is commented as minting redeemers, what is even more wrong.

# TODO
-- export redeemers of other types in Plutus.Contract.Wallet (mkRedeemers)