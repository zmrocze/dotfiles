...
{-# INLINE checkLengthConstructor #-}
-- | Check if ByteString has length equal to len and apply constructor f. 
checkLengthConstructor :: Haskell.Int -> (BuiltinByteString -> a) -> BS.ByteString -> Maybe a
checkLengthConstructor len f bs =
...
scriptHash = checkLengthConstructor 28 UnsafeScriptHash
...
validatorHash = checkLengthConstructor 28 UnsafeValidatorHash
...
datumHash = checkLengthConstructor 32 UnsafeDatumHash
...
redeemerHash = checkLengthConstructor 32 UnsafeRedeemerHash
...
mintingPolicyHash = checkLengthConstructor 28 UnsafeMintingPolicyHash
...
stakeValidatorHash = checkLengthConstructor 28 UnsafeStakeValidatorHash
