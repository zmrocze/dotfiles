...
module Plutus.V1.Ledger.Scripts(
    ...
    MintingPolicyHash (..),
    StakeValidatorHash (..),
    scriptHash, validatorHash, datumHash, redeemerHash) where
...
redeemerHash :: BS.ByteString -> Maybe a
...
mintingPolicyHash = checkMaxLengthConstructor 28 MintingPolicyHash
