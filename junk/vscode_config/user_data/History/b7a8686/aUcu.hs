...
addSomeWallet :: MonadIO m => TestWallet' k -> ReaderT ClusterEnv m BpiWallet
addSomeWallet funds =
...
addSomeWalletDir :: MonadIO m => TestWallet' k -> Maybe FilePath -> ReaderT ClusterEnv m BpiWallet
