...
import Ledger.Tx (CardanoTx, Tx, TxInput, TxOut, TxOutRef (..), TxOutTx (TxOutTx, txOutTxOut, txOutTxTx),
                  collateralInputs, fillTxInputWitnesses, getCardanoTxCollateralInputs, getCardanoTxId,
                  getCardanoTxInputs, getCardanoTxOutputs, inputs, spentOutputs, txId,
...
import Plutus.V1.Ledger.Tx (TxIn, TxOut, TxOutRef (..), txOutPubKey)
