...
import Ledger.Tx (CardanoTx, TxOut, TxOutRef (..), getCardanoTxId, getCardanoTxInputs, getCardanoTxOutputs, getCardanoTxCollateralInputs
...
import Plutus.V1.Ledger.Tx (TxIn, txOutDatum, txOutPubKey)
