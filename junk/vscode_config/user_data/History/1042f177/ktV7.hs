...
-- TODO: create a config option to create a payment address or a payment-delegation address
...
--       ( maybe
--           CAPI.NoStakeAddress
--           ( CAPI.StakeAddressByValue
--               . CAPI.StakeCredentialByKey -- FIXME: Cardano.Api (in cardano-api-1.35.3) does not re-export the constructors for StakeCredential
--               . CAPI.verificationKeyHash
--               . sVKey
--           )
--           stake
