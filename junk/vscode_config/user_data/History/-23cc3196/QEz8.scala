...
case class Not[X](tag : T, sub : GFFormula[X]) extends GFFormula[X]
case class And[X](tag : T, left : GFFormula[X], right : GFFormula[X]) extends GFFormula[X]
case class Or[X](tag : T, left : GFFormula[X], right : GFFormula[X]) extends GFFormula[X]
case class Atom[X](tag : T, atom : AtomicFormula[X]) extends GFFormula[X]
case class Forall[X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[X]) extends GFFormula[X]
case class Exist[X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[X]) extends GFFormula[X]
