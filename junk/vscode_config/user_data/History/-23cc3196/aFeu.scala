...
case class Not[T, X](tag : T, sub : GFFormula[X]) extends GFFormula[X]
case class And[T, X](tag : T, left : GFFormula[X], right : GFFormula[X]) extends GFFormula[X]
case class Or[T, X](tag : T, left : GFFormula[X], right : GFFormula[X]) extends GFFormula[X]
case class Atom[T, X](tag : T, atom : AtomicFormula[X]) extends GFFormula[X]
case class Forall[T, X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[X]) extends GFFormula[X]
case class Exist[T, X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[X]) extends GFFormula[X]
