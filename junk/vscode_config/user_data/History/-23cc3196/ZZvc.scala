...
case class AndF[A, T, X](tag : T, left : GFFormula[T, X], right : GFFormula[T, X]) extends GFFormula[T, X]
case class OrF[A, T, X](tag : T, left : GFFormula[T, X], right : GFFormula[T, X]) extends GFFormula[T, X]
case class ForallF[A, T, X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[T, X]) extends GFFormula[T, X]
case class ExistF[A, T, X](tag : T, variables : List[X], guard : AtomicFormula[X], sub : GFFormula[T, X]) extends GFFormula[T, X]
