...
import Test.Plutip.Internal.BotPlutusInterface.Wallet (BpiWallet, walletPaymentPkh, walletStakePkh)
...
import Test.Plutip.Contract.Types (WalletAddress)
  ...
  where
    ...
    mkPabConfig pparams =
      PABConfig
        ...
        , pcLogLevel = logLvl
        , pcOwnPubKeyHash = Plutip.ownPaymentPubKeyHash bpiWallet
        , pcOwnStakePubKeyHash = Plutip.ownStakePubKeyHash bpiWallet
