...
import Test.Plutip.Contract.Types (WalletType)
...
import Test.Plutip.Internal.BotPlutusInterface.Types (WalletInfo, ownStakePubKeyHash, ownPaymentPubKeyHash, BpiWallet, WalletInfo' (WalletInfo', getWalletInfo))
  ...
  where
    ...
    mkPabConfig pparams =
      PABConfig
        ...
        , pcLogLevel = logLvl
        , pcOwnPubKeyHash = unPaymentPubKeyHash $ ownPaymentPubKeyHash $ getWalletInfo walletInfo
