...
initLovelace tag initial = TestWallets $ TestWallet initial Nothing tag :| []
...
initLovelaceAssertValueWith tag initial ord expect = TestWallets $ TestWallet initial (Just (ord, expect)) tag :| []
