...
import Ledger.Tx.Types.TxInput as Export
    ( TxInputType(TxConsumeScriptAddress, TxConsumeSimpleScriptAddress,
                  TxConsumePublicKeyAddress),
      TxInput(TxInput, txInputRef) )
...
import Plutus.V1.Ledger.Api (Redeemer,
                             addressCredential)
import Plutus.V1.Ledger.Scripts (MintingPolicyHash (MintingPolicyHash), MintingPolicy (MintingPolicy), Script, ScriptHash (ScriptHash),
