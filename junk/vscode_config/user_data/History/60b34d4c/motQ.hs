...
-- withConfiguredClusterAux ::
--   PlutipConfig ->
--   String ->
--   (IO _ -> IO a) ->
--   IO a
-- withConfiguredClusterAux :: PlutipConfig
--   -> (IO
--       (GHC.Conc.Sync.TVar
--          (Test.Plutip.Internal.LocalCluster.ClusterStatus
--             (ClusterEnv, [NonEmpty BpiWallet])),
--        (ClusterEnv, [NonEmpty BpiWallet]))
--     -> TestTree)
--   -> TestTree
-- withConfiguredClusterAux conf f =
--   withResource (startCluster conf setup) (stopCluster . fst) f 
