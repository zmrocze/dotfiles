...
pubKeyHashFromHex hex = let pubk = fromString hex in if lengthOfByteString (getPubKeyHash pubk) == 28 then Just pubk else Nothing

pubkey :: Maybe PubKeyHash
pubkey = pubKeyHashFromHex "6e498ba87f09dbd6b744d264b4b3eb8d423269ebc8d56a789b96484e"
