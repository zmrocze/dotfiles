...
import Ledger (Script(unScript), fromCompiledCode, PubKeyHash)
import Control.Lens ((^.))
...
pubkey = let pubk = fromString "6e498ba87f09dbd6b744d264b4b3eb8d423269ebc8d56a789b96484e"
    in if length (getPubKeyHash pubk) == 28 then Just pubk else Nothing
