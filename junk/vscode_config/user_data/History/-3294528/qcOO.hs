...
TxInputWitnessed ref (ConsumeScriptAddress failValidator unitRedeemer unitDatum)
    -- try and spend the script output
    invalidTxn <- forAll $ Gen.genValidTransactionSpending [(snd outToSpend) failValidator unitRedeemer unitDatum] totalVal
