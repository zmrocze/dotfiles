...
-- TODO: Implement for TxMetadata
deriving anyclass instance OpenApi.ToSchema C.TxMetadata
instance OpenApi.ToSchema C.TxMetadataValue where
  -- TODO: implement the schema
  declareNamedSchema _ = return $ NamedSchema (Just "TxMetadataValue") mempty
