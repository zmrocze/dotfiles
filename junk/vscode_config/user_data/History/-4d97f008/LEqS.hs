...
-- | Removes given utxo from the UtxoResponse page. Used to remove collateral utxo.
-- Receives `Nothing` if Collateral uninitialized.
removeCollateral :: Maybe CollateralUtxo -> Page TxOutRef -> Page TxOutRef
