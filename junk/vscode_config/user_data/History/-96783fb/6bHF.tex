...
\begin{itemize}
    ...
    \item For some $k$ one of the terms has a Skolem term at the index $k$ and the other has a variable $x_i$ for some $i$. Literals are not ground, therefore the Skolem term contains the varia 
\end{itemize}
