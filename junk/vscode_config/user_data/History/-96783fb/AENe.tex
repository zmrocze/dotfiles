...
\begin{itemize}
    ...
    \item There are no Skolem terms in the literals. Then both literals must be of the form $R(x_{i..j})$. The literal $A_1$ contains all the variables of $A_2$, so the sequence of variables of $A_2$ is an infix of the sequence of variables of $A_1$.
\end{itemize}
