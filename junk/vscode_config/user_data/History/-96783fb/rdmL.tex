...
It is compiled with the standard \emph{sbt} tool as described in the projects \path{implementation/README.md}. 
...
The implementation works correctly for all GF sentences but guarantees single exponential complexity only for FGF sentences.
