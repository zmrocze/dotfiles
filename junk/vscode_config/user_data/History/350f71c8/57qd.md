...
We recommend expanding section 3.2.4 of the yellowpaper with point on `RecordEpochToScaleToSum` redeemer.adding a documentation mentioned in the points 1 and 4.
