...
import BotPlutusInterface.Types (ContractStats, TxBudget, estimatedBudgets, LogsList, getLogsList)
...
ppShowLogs :: ExecutionResult w e a -> String
ppShowLogs = ppShowList . map snd . getLogsList . contractLogs
