...
compareApplied :: forall (m :: Type -> Type). Monad m => MonadError Error m => (String -> m PlutusScript) -> String -> Tuple (Array PlutusData) String -> m Unit
...
lookupAux :: forall (m :: Type -> Type). MonadError Error m => (TextEnvelope -> Maybe PlutusScript) -> String -> m PlutusScript
