...
import Ledger (OnChainTx (..), SomeCardanoApiTx (SomeTx), Tx (..), TxOutRef (..), onCardanoTx,
               txId, txSpendingRedeemers, ScriptTag (Reward, Mint, Cert), txRewardingRedeemers, txMintingRedeemers, txCertifyingRedeemers)
...
import Plutus.Contract.CardanoAPI (fromCardanoTx, setValidity, toCardanoTxOut, toCardanoTxOutDatumHash, fromCardanoTxOut)
