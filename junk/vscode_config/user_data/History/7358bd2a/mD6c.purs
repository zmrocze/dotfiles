...
data ClusterStartupFailureReason
  ...
  | NegativeLovelaces
  | NodeConfigNotFound
  | WaitingForFundedWalletsFailed String
...
instance DecodeAeson ClusterStartupFailureReason where
  decodeAeson aeson = do
    ...
    obj .: "tag" >>= case _ of
      "ClusterIsRunningAlready" -> pure ClusterIsRunningAlready
      "NegativeLovelaces" -> pure NegativeLovelaces
      "NodeConfigNotFound" -> pure NodeConfigNotFound
      "WaitingForFundedWalletsFailed" -> do
        contents <- obj .: "contents"
        WaitingForFundedWalletsFailed <$> decodeAeson contents
      _ -> do
