...
saveWallets :: MonadIO m => BpiWallet -> Maybe FilePath -> ClusterEnv -> IO (Either BpiError ())
...
ledgerPaymentPkh :: BpiWallet -> PubKeyHash
ledgerPaymentPkh = walletPkh

encodeByteString :: B.ByteString -> Text
