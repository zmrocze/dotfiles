...
txinfoV2 = V2.TxInfo
    ...
    , V2.txInfoRedeemers   = V2.fromList []
...
contextV1 = ScriptContext txinfoV1 (Spending (TxOutRef (TxId "cccc") 0))
contextV2 = V2.ScriptContext txinfoV2 (Spending (TxOutRef (TxId "cccc") 0))

contextV1Data :: PlutusTx.Data
contextV1Data = toData contextV1  

contextV2Data :: PlutusTx.Data
contextV2Data = toData contextV2