...
import BlockType (BlockReference, TXID, BlockHeader, coinbaseOutputs, outputs, Output (Output))
...
insertOwnedUTXO (OwnedUTXO (UTXO txid vout (Output cents addr)) (Keys pub priv)) = insertOwnedKeys txid (fromInteger vout) pub priv
