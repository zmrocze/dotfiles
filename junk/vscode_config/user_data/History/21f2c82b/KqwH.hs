...
signingKeyFilePathInDir :: FilePath -> CAPI.Hash CAPI.PaymentKey -> Text
...
keyFilePathInDir :: forall a . CAPI.SerialiseAsRawBytes (CAPI.Hash a) => FilePath -> FilePath -> CAPI.Hash a -> FilePath -> FilePath
keyFilePathInDir dir pref h ext = dir </> pref <> "-" <> show (CAPI.serialiseToRawBytesHexText h) <.> ext
