...
stakingSigningKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.StakingKey -> Text
stakingSigningKeyFilePathInDir dir pubk = keyFilePathInDir dir "signing-key" pubk ".skey"

stakingVerificationKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.PaymentKey -> Text
stakingVerificationKeyFilePathInDir dir pubk = keyFilePathInDir dir "verification-key" (CAPI.verificationKeyHash pubk) ".vkey"
