...
signingKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.PaymentKey -> Text
signingKeyFilePathInDir dir pubk = keyFilePathInDir dir "signing-key" pubk ".skey"

verificationKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.PaymentKey -> Text
verificationKeyFilePathInDir dir pubk = keyFilePathInDir dir "verification-key" (CAPI.verificationKeyHash pubk) ".vkey"

stakingSigningKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.StakeKey -> Text
stakingSigningKeyFilePathInDir dir pubk = keyFilePathInDir dir "staking-signing-key" pubk ".skey"

stakingVerificationKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.StakeKey -> Text
stakingVerificationKeyFilePathInDir dir pubk = keyFilePathInDir dir "staking-verification-key" (CAPI.verificationKeyHash pubk) ".vkey"
