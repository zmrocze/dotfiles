...
delegationSigningKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.PaymentKey -> Text
delegationSigningKeyFilePathInDir dir pubk = keyFilePathInDir dir "signing-key" pubk ".skey"

delegationVerificationKeyFilePathInDir :: Text -> CAPI.VerificationKey CAPI.PaymentKey -> Text
delegationVerificationKeyFilePathInDir dir pubk = keyFilePathInDir dir "verification-key" (CAPI.verificationKeyHash pubk) ".vkey"
