...
import Constructors ( Val(..), Arg(..), Allowed(..) )
...
langExtensions = [I.LambdaCase]
preludePath = "/home/zmrocze/code/haskell/hsh/HshPrelude.hs"
constructorsPath = "/home/zmrocze/code/haskell/hsh/src/Constructors.hs"
...
tryRun expr =
  let expr1 = parens expr in do
    ...
    I.setImportsQ [("HshPrelude", Nothing), ("Constructors", Nothing), ("Data.Map", Just "M")]
