...
tryRun expr =
  let expr1 = parens expr in do
    ...
    I.setImportsQ [
      ("Language.Haskell.Interpreter", Just "Language.Haskell.Interpreter"),
      ("Prelude.HshPrelude", Nothing), 
      ("Hsh.Constructors", Nothing)
      ]
    I.setImportsQ extraQualifiedImports
