...
import Aeson (class DecodeAeson, class EncodeAeson, JsonDecodeError(TypeMismatch, UnexpectedValue), decodeAeson, encodeAeson', toStringifiedNumbersJson, (.:))
...
newtype ClusterStartupRequest = ClusterStartupRequest { 
  ...
  , clusterEpochSize :: EpochLength
  , clusterSlotLength :: SlotLength
}
