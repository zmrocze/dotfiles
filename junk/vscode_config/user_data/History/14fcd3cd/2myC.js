...
if (typeof BROWSER_RUNTIME != "undefined" && BROWSER_RUNTIME) {
  ...
  scripts["always-fails-big-arg.plutus"] = read_script("applied/always-fails-big-arg.plutus")
  scripts["always-fails-no-args.plutus"] = read_script("applied/always-fails-no-args.plutus")
  scripts["always-fails-unit.plutus"] = read_script("applied/always-fails-unit.plutus")
  scripts["always-succeeds-v2-big-arg.plutus"] = read_script("applied/always-succeeds-v2-big-arg.plutus")
  scripts["always-succeeds-v2-no-args.plutus"] = read_script("applied/always-succeeds-v2-no-args.plutus")
  scripts["always-succeeds-v2-unit.plutus"] = read_script("applied/always-succeeds-v2-unit.plutus")
  scripts["check-datum-is-inline-big-arg.plutus"] = read_script("applied/check-datum-is-inline-big-arg.plutus")
  scripts["check-datum-is-inline-no-args.plutus"] = read_script("applied/check-datum-is-inline-no-args.plutus")
  scripts["check-datum-is-inline-unit.plutus"] = read_script("applied/check-datum-is-inline-unit.plutus")
  scripts["include-datum-big-arg.plutus"] = read_script("applied/include-datum-big-arg.plutus")
  scripts["include-datum-no-args.plutus"] = read_script("applied/include-datum-no-args.plutus")
  scripts["include-datum-unit.plutus"] = read_script("applied/include-datum-unit.plutus")
  scripts["one-shot-minting-big-arg.plutus"] = read_script("applied/one-shot-minting-big-arg.plutus")
  scripts["one-shot-minting-no-args.plutus"] = read_script("applied/one-shot-minting-no-args.plutus")
  scripts["one-shot-minting-unit.plutus"] = read_script("applied/one-shot-minting-unit.plutus")
  scripts["one-shot-minting-v2-big-arg.plutus"] = read_script("applied/one-shot-minting-v2-big-arg.plutus")
  scripts["one-shot-minting-v2-no-args.plutus"] = read_script("applied/one-shot-minting-v2-no-args.plutus")
  scripts["one-shot-minting-v2-unit.plutus"] = read_script("applied/one-shot-minting-v2-unit.plutus")
  scripts["redeemer1-validator-big-arg.plutus"] = read_script("applied/redeemer1-validator-big-arg.plutus")
  scripts["redeemer1-validator-no-args.plutus"] = read_script("applied/redeemer1-validator-no-args.plutus")
  scripts["redeemer1-validator-unit.plutus"] = read_script("applied/redeemer1-validator-unit.plutus")
