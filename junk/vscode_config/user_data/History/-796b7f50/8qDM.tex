...
\vuln
    ...
    { % Description 
    There are currently no tests attempting to spend . The collector logic bypasses all checks in this case, thus the fee collection logic of the protocol is never tested. Simply changing the fee seems to make tests using depositTx fail.
    }
    { % Recommended Fix
