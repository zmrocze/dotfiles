...
\vuln
    ...
    { % Description 
    There are currently no tests attempting to spend collected fees. Thus both the `Collector` validator and `Stability Pool Manager` is therefore not checked by the tests.
    }
    { % Recommended Fix
