...
\vuln
    ...
    { % Description 
    There are currently no tests attempting to spend collected fees. Thus both the `Collector` validator and the `Stability Pool Manager` aren't checked by the tests.
    }
    { % Recommended Fix
