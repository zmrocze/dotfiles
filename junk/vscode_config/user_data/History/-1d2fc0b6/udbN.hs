...
import Ledger.Tx (ChainIndexTxOut, Language (PlutusV1, PlutusV2),
...
import Plutus.V1.Ledger.Api (Datum (Datum), DatumHash, POSIXTimeRange, Value)
...
addOwnInput ScriptInputConstraint{icRedeemer, icTxOutRef} = do
    ...
    case Typed.tyTxInTxIn txIn of
        ...
        Tx.TxIn outRef (Just (Tx.ConsumeScriptAddress PlutusV1 validator rs dt)) -> do
            unbalancedTx . tx %= Tx.addScriptTxInput outRef PlutusV1 validator rs dt
    ...
    MustSpendScriptOutput txo red -> do
        ...
        case mscriptTXO of
          Just ((_, validator, pv), (_, datum), value) -> do
            unbalancedTx . tx %= Tx.addScriptTxInput txo pv validator red datum
    ...
    MustSpendScriptOutputWithMatchingDatumAndValue vh datumPred valuePred red -> do
        ...
        case opts of
            ...
            [(ref, Just ((_, validator, version), (_, datum), value))] -> do
                unbalancedTx . tx %= Tx.addScriptTxInput ref version validator red datum
                valueSpentInputs <>= provided value
