...
Do:
 ...
 9. Previous command generated addresses than need to be filled with money. List the addresses in `byron-genesis.yaml`. You can use `print-byron-mainnet-addresses.zsh`.
