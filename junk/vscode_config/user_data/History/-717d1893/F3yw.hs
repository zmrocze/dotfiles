...
x = deserialiseFromCBOR (AsScript AsPlutusScriptV1) $ B.toStrict $ serialise script

b = writeFileTextEnvelope @(PlutusScript PlutusScriptV1) "always-succeeds.plutus" (Just "My little script") _
