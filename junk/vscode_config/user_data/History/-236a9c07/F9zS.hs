...
import Ledger.Constraints (mustPayToPubKey, adjustUnbalancedTx)
...
import Ledger.Tx (CardanoTx, TxOutRef, getCardanoTxInputs, txInRef, Tx)
...
getUnspentOutput = do
    ...
    tx <- Contract.balanceTx (adjustUnbalancedTx _ utx)
