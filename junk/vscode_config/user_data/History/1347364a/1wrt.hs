...
mkCollateralTx pabConf = Constraints.mkTx @Void mempty txc
  where
    ...
    txc = (maybe Constraints.mustPayToPubKey (flip Constraints.mustPayToPubKeyAddress) (pcOwnStakePubKeyHash pabConf)) (PaymentPubKeyHash $ pcOwnPubKeyHash pabConf) (collateralValue pabConf)
