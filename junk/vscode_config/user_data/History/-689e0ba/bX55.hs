...
buildTx (MustHashDatum1' datumhash datum) a tx = a $ tx {slOtherData = Map.insert datumhash datum (slOtherData tx) }
buildTx (MustValidateIn1' timerange) a tx = a tx -- what to do here?
