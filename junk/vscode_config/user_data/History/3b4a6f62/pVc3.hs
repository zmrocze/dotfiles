...
liquidateHelper
  ...
  reward' =
    ...
    where
      ...
      isEpochIncrease = getSPInteger snapshotD == getSPInteger burn

      isScaleIncrease :: Bool
      isScaleIncrease = getSPInteger (snapshotP |*| p_i) < newScaleMultiplier
      ...
      p_i :: SPInteger
      p_i = toSPInteger 1 |-| (burn |/| snapshotD)
      ...
      liquidateSnapshot =
        ...
        where
          ...
          newSnapshotP =
            SPInteger
              ( (if newScale > snapshotScale then newScaleMultiplier else 1)
