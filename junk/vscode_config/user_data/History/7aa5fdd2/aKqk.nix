{
  ...
  inputs = {
    ...
    plutip.url = "github:mlabs-haskell/plutip/ae7f59c5e54befb30fd075e3c79a7821167ea5d9";
    ...
    cardano-wallet.url = "github:zmrocze/cardano-wallet?rev=3512fddd1615c941e41161fb0d67570cd36f9e60";
