...
import Ledger.Tx (CardanoTx (..), txId, updateUtxoCollateral, TxInput (TxInput, txInputRef), TxOut, Tx(..), inputs, signatures, datumWitnesses, lookupMintingPolicy, fillTxInputWitnesses, collateralInputs, pubKeyTxInputs)
