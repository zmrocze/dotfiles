...
foreign import apply_params_to_script_with_errors 
  ...
  -> CSL.PlutusData -> CSL.PlutusScript -> CSL.PlutusScript
...
applyArgsWithErrors script args =
  case (S.convertPlutusData (List args)) of
    Nothing -> Nothing
    Just args1 -> D.convertPlutusScript $ apply_params_to_script_with_errors args1 (S.convertPlutusScript script)