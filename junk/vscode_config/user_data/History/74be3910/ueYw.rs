...
fn encode_list<'a, C, W: minicbor::encode::Write>(
    len : usize, 
    a : std::slice::Iter<PlutusData>,
    e: &'a mut minicbor::Encoder<W>,
    ctx: &mut C,
    // ) -> Result<&mut minicbor::Encoder<W>, minicbor::encode::Error<W::Error>> 
    ) -> Result<(), minicbor::encode::Error<W::Error>> {
    // Mimics haskell implementation from https://github.com/input-output-hk/plutus/blob/9538fc9829426b2ecb0628d352e2d7af96ec8204/plutus-core/plutus-core/src/PlutusCore/Data.hs#L140:
...
impl<C> minicbor::encode::Encode<C> for PlutusData {
    fn encode<W: minicbor::encode::Write>(
        ...
        match self {
            ...
            Self::Array(a) => {
                encode_list(a.len(), a.iter(), e, ctx)?;
            }
        };
