...
unDummyPrivateKey (FromSKey key) = fromRight (error "dupa") $ vkeyToDummyPrivKey' $ getVerificationKey key
unDummyPrivateKey (FromVKey key) = fromRight (error "dupa") $ vkeyToDummyPrivKey' key
