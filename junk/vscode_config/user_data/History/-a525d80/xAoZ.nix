{
  ...
  inputs = {
    ...
    CHaP.url = "github:input-output-hk/cardano-haskell-packages/706f3589a1383e5e13efe73aa15ea5fbd6c26a4b";
    CHaP.flake = false;
    # onchain plutarch
    # TODO: nixpkg follows?
  ...
  outputs = inputs@{ self, nixpkgs, haskell-nix, cardano-transaction-lib, tooling, CHaP, ... }:
    let
      # GENERAL
