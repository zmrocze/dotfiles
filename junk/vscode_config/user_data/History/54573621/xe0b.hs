...
toCardanoMintWitness :: PV1.Redeemer -> Maybe (Versioned PV1.MintingPolicy) -> Either ToCardanoError (C.ScriptWitness C.WitCtxMint C.BabbageEra)
...
toCardanoScriptWitness :: PV1.ToData a =>
  ...
  -> a
  -> Versioned PV1.Script
  -> Either ToCardanoError (C.ScriptWitness witctx C.BabbageEra)
toCardanoScriptWitness datum redeemer (Versioned lang script) = (case lang of
    L.PlutusV1 ->
      C.PlutusScriptWitness C.PlutusScriptV1InBabbage C.PlutusScriptV1
