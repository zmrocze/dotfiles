  ...
  where
    ...
    toStakeWitness withdrawalRedeemer cred = case cred of
      ...
      PV1.ScriptCredential _vh -> case (,) <$> withdrawalRedeemer <*> P.lookupValidator txScripts _vh of
        Just (redeemer, script) -> C.BuildTxWith . C.ScriptWitness C.ScriptWitnessForStakeAddr <$> toCardanoScriptWitness P.PlutusV1 C.NoScriptDatumForStake redeemer script
