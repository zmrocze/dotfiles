  ...
  where
    ...
    toStakeWitness withdrawalRedeemer cred = case cred of
      ...
      PV1.ScriptCredential _vh -> case (,) <$> withdrawalRedeemer <*> P.lookupValidator txScripts _vh of
        -- Hardcoded V1.
        Just (redeemer, P.Validator script) -> C.BuildTxWith . C.ScriptWitness C.ScriptWitnessForStakeAddr <$> toCardanoScriptWitness P.PlutusV1 C.NoScriptDatumForStake redeemer script
