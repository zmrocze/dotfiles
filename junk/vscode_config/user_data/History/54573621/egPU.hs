...
fromCardanoScriptInEra :: C.ScriptInEra era -> Maybe (P.Script, L.LedgerPlutusVersion)
...
toCardanoScriptInEra :: P.Script -> L.LedgerPlutusVersion -> Either ToCardanoError (C.ScriptInEra C.BabbageEra)
...
fromCardanoScriptInAnyLang :: C.ScriptInAnyLang -> Maybe (P.Script, L.LedgerPlutusVersion)
