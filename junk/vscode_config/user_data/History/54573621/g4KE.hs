...
toCardanoScriptWitness datum redeemer (P.Versioned lang script) = (case lang of
    P.PlutusV1 ->
      C.PlutusScriptWitness C.PlutusScriptV1InBabbage C.PlutusScriptV1
...
fromCardanoPlutusScript = Codec.deserialise . BSP.fromStrict . C.serialiseToRawBytes
...
toCardanoPlutusScript asPlutusScriptType =
    ...
    . deserialiseFromRawBytes asPlutusScriptType . BSP.toStrict . Codec.serialise
