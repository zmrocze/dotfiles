...
import Plutus.ChainIndex.Tx (ChainIndexTx (..), citxData, citxRedeemers, citxScripts, citxTxId, txOutsWithRef, ChainIndexTxOut (ChainIndexTxOut, citoAddress, citoValue))
