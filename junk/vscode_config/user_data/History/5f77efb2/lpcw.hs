...
type PostApi = "query" :> QueryParam "key" Text :> Get '[PlainText] ()
type GetApi = "input" :> ReqBody '[PlainText] Text :> Post '[PlainText] Natural
...
server var = handlePost var :<|> handleGet var
  where 
    ...
    handlePost :: TVar CountMap -> Maybe Text -> Handler ()
