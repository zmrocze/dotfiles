...
main = launchAff_ $ do
  ...
  case args of 
    [_, indexFilepath, modulesDirpath] -> do 
      index <- readIndex indexFilepath
      if validateIndex index then do
        writeTextFile UTF8 (modulesDirpath <</>> "Scripts.js") $ jsModule index
...
nodeImports =
  "let read_script;\n"
  <>
  ifBrowserRuntime "" nodeImportsSnippet

nodeImportsSnippet :: String
nodeImportsSnippet = 
  """
  const fs = require("fs");
