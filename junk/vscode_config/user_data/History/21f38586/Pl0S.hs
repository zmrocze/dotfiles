...
import Ledger (Address, BlockId, CardanoTx, ChainIndexTxOut, OnChainTx, PaymentPubKey, PaymentPubKeyHash, PubKey,
               ...
               TxOut, TxOutRef, TxOutTx, UtxoIndex, ValidationPhase, TxInputType, Certificate)
...
certificateBridge :: BridgePart
certificateBridge = do
    typeName ^== "Certificate"
    typeModule ^== "Ledger.Tx.Types.Certificate"
    pure psString
...
ledgerTypes =
    ...
    , equal . genericShow . argonaut $ mkSumType @Withdrawals
