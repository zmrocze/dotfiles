...
import Ledger (Address, BlockId, CardanoTx, Certificate, ChainIndexTxOut, OnChainTx, PaymentPubKey, PaymentPubKeyHash,
               ...
               TxInType, TxInputType, TxOut, TxOutRef, TxOutTx, UtxoIndex, ValidationPhase, Withdrawal, TxInput, Script, MintingPolicyHash, ScriptHash)
...
ledgerTypes =
    ...
    , genericShow . order . argonaut $ mkSumType @Script
    ...
    , order . genericShow . argonaut $ mkSumType @MintingPolicyHash
    , order . genericShow . argonaut $ mkSumType @ScriptHash
