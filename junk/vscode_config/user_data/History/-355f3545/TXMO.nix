{
  ...
  inputs = {
    ...
    bot-plutus-interface = {
      url = "github:mlabs-haskell/bot-plutus-interface?rev=2f4b4c5104bd573039995d6d7eef0c9235ddbc32";
    ...
    cardano-wallet.url = "github:mlabs-haskell/cardano-wallet?rev=18a931648550246695c790578d4a55ee2f10463e";
