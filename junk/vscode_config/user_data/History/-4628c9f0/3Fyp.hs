...
data TxInType =
      ...
      ConsumeScriptAddress !ValidatorHash !RedeemerHash !DatumHash -- ^ A transaction input that consumes a script address with the given validator, redeemer, and datum.
...
inScripts :: TxIn -> Maybe (ValidatorHash, RedeemerHash, DatumHash)
...
scriptTxIn :: TxOutRef -> ValidatorHash -> RedeemerHash -> DatumHash -> TxIn
