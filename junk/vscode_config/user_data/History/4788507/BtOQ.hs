...
type TestContractConstraints (w :: Type) (e :: Type) (k :: WalletType) (a :: Type) =
  ( ToJSON w
  , Monoid w
  , Show w
  , Show e
...
-- | Test contract
data TestContract (w :: Type) (e :: Type) (k :: WalletType) (a :: Type) 
  = TestContract
      (Predicate w e k a)
...
instance
  forall (w :: Type) (e :: Type) (k :: WalletType) (a :: Type).
