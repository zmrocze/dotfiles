...
import Test.Plutip.Internal.BotPlutusInterface.Types (WalletType(..), WalletTag)
...
data WalletLookups k = WalletLookups {
  lookupWallet :: 
    forall (w :: Type) (s :: Row Type) (e :: Type) (t :: WalletType) (m :: Type -> Type).
    MonadError (Either WalletTypeError e) m =>
    WalletTag t k
    -> m (WalletInfo t)
  , 
  lookupAddress ::
    forall (w :: Type) (s :: Row Type) (e :: Type) (t :: Type) (m :: Type -> Type). 
    MonadError (Either WalletTypeError e) m =>
    k
    -> m Address
}
